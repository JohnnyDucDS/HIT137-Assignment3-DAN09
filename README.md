# HIT137 Assignment 3 - Game Manager Part

## Files
- `game_manager.py` = portable game manager module for integration.
- `demo_app.py` = optional Tkinter demo showing how to use the manager.
